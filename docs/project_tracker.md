...
| P2 模块化类脑网络 | IN_PROGRESS | GATE-2 PENDING | 完整 MPS suite 已通过；等待独立 verifier 与远程 CPU CI |
...
| P2-15 | CPU/MPS 测试与 CLI/CI | IN_PROGRESS | CPU 微型及完整 MPS suite 已通过；远程 CPU CI 待核验 |
